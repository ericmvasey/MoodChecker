...
public class MoodNotificationReciever extends BroadcastReceiver
{
    public static final String CONTENT_KEY = "contentText";

    public MoodNotificationReciever()
    {
    }
    ...
    {
        Intent displayIntent = new Intent(context, MoodDisplayActivity.class);
